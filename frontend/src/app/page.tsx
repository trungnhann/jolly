...
export default function Home() {
  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-start px-6 py-16">
      {/* Welcome Hero Banner */}
      <div className="w-full max-w-5xl rounded-(--radius) border border-border/50 bg-card/80 p-8 shadow-lg backdrop-blur-xl relative overflow-hidden before:absolute before:inset-x-0 before:top-0 before:h-[2px] before:bg-gradient-to-r before:from-primary/80 before:to-transparent">
        <div className="flex items-center justify-between gap-6 relative z-10">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground font-medium max-w-2xl">
              {t("home.description")}
            </p>
          </div>
        </div>

        <div className="mt-10 grid gap-4 sm:grid-cols-2 relative z-10 max-w-2xl">
          <Link
            href="/register"
          ...
          >
            <div className="absolute top-0 left-0 h-1 w-full bg-linear-to-r from-primary to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
